...
export const wowConfig: WowConfig = {
  ...
  ilvlTiers: {
    poor: { min: 0, max: 232, color: 'var(--color-ilvl-poor)' },
    common: { min: 233, max: 245, color: 'var(--color-ilvl-common)' },
    uncommon: { min: 246, max: 258, color: 'var(--color-ilvl-uncommon)' },
    rare: { min: 259, max: 271, color: 'var(--color-ilvl-rare)' },
    epic: { min: 272, max: Infinity, color: 'var(--color-ilvl-epic)' },
  },
  tierSlots: ['chest', 'hands', 'head', 'legs', 'shoulder'],
  enchantableSlots: ['head', 'shoulder', 'chest', 'legs', 'feet', 'finger1', 'finger2', 'mainhand'],
