  ...
  <div class="max-w-6xl mx-auto p-3 sm:p-4 md:p-5 relative z-10">
    ...
    <div
      ...
      <div class="flex flex-wrap gap-2 sm:gap-3">
        <!-- 篩選按鈕 -->
        <button @click="toggleWarningsFilter"
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"
            class="stroke-wow-gold-light" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <!-- 篩選指示器 - 當篩選開啟時顯示 -->
    <div v-if="showOnlyWarnings" class="mb-4 bg-[rgba(179,0,0,0.2)] border border-wow-horde rounded py-2 px-4">
      <p class="flex items-center justify-center text-wow-text-light">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" class="stroke-wow-horde mr-2"
          fill="none" stroke="currentColor" stroke-width="2">
          <path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"></path>
          <line x1="12" y1="9" x2="12" y2="13"></line>
          <line x1="12" y1="17" x2="12.01" y2="17"></line>
        </svg>
        <span>目前只顯示有裝備警告的玩家 ({{ players.length }} 位)</span>
      </p>
    </div>

    <!-- 沒有符合條件的結果時 -->
    <div v-if="!loading && !error && players.length === 0 && showOnlyWarnings"
      ...
      <div v-for="player in players" :key="player.name"
          ...
          <div class="flex justify-between items-center">
            <div class="flex items-center gap-2 sm:gap-3">
              <div
                ...
                <img v-if="player.thumbnailUrl" :src="player.thumbnailUrl" alt="Character Portrait"
                  class="w-full h-full object-cover" />
                <div v-else
                  class="w-full h-full bg-[rgba(0,0,0,0.5)] flex items-center justify-center text-wow-text-light">
                  <span class="text-xs">無圖</span>
                </div>
              </div>
              <div>
                <h3 class="font-wow-title font-bold text-lg md:text-xl tracking-wide"
        ...
        <div class="p-3 md:p-4 space-y-2.5 md:space-y-3">
          ...
          <div v-if="player.enhancementWarning"
            ...
            <p class="text-xs text-wow-text-light leading-relaxed whitespace-pre-wrap">{{ player.enhancementWarning }}
            </p>
          </div>
        </div>
